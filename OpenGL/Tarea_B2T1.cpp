...
int main()
{
	...
	Shader ourShader("shaders/vertexshader_B2T1.vs", "shaders/fragmentshader_B2T1.fs");
	...
	float vertices[] = {
		...
		-0.37f, -0.245f, 0.0f,  0.0f, 0.82f, // izquierda 3 verde oscuro D
		 0.48f, -0.307f, 0.0f,  0.58f, 0.276f, // derecha 3 verde oscuro E
		 0.02f, -0.71f, 0.0f,   0.0f, 0.26f, // arriba 3 verde oscuro F
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		float offsetPosition = sin(glfwGetTime()) * 0.5;
		ourShader.setFloat("offsetPosition", offsetPosition);
